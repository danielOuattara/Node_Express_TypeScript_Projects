...
router.route("/update-user").patch(middlewares_1.authenticateUser, userControllers_1.updateUser);
router.route("/update-password").patch(middlewares_1.authenticateUser, userControllers_1.updateUserPassword);
